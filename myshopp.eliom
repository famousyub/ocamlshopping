...
let%shared () =
  ...
  Eliom_registration.Any.register ~service:Os_services.action_link_service
    (Os_session.Opt.connected_fun Myshopp_handlers.action_link_handler);
  ...
  Eliom_registration.Action.register
    ...
    Myshopp_handlers.update_language_handler;
  Myshopp_base.App.register ~service:Os_services.main_service
    (Myshopp_page.Opt.connected_page
       Myshopp_handlers.main_service_handler);
  Myshopp_base.App.register
    ~service:Myshopp_services.about_service
    (Myshopp_page.Opt.connected_page
       Myshopp_handlers.about_handler);
  Myshopp_base.App.register
    ~service:Myshopp_services.settings_service
    (Myshopp_page.Opt.connected_page
       Myshopp_handlers.settings_handler)

let%server () =
  Eliom_registration.Ocaml.register
    ~service:Myshopp_services.upload_user_avatar_service
    (Os_session.connected_fun
       Myshopp_handlers.upload_user_avatar_handler)

(* Print more debugging information when <debugmode/> is in config file
   (DEBUG = yes in Makefile.options).
   Example of use:
   let section = Lwt_log.Section.make "Myshopp:sectionname"
   ...
    ...
    ignore
      [%client
        ((* Eliom_config.debug_timings := true; *)
         ...
         Lwt_log_core.add_rule "Myshopp*" Lwt_log_js.Debug
         (* Lwt_log_core.add_rule "*" Lwt_log_js.Debug *)
          : unit)];
    (* Lwt_log_core.add_rule "*" Lwt_log.Debug *)
    Lwt_log_core.add_rule "Myshopp*" Lwt_log.Debug)
